...
<main class="pt-90">
    <section class="shop-main container d-flex pt-4 pt-xl-5">
                            ...
                            <ul class="list list-inline mb-0 brand-list">
                                ...
                                <li class="list-item">
                                    <span class="menu-link py-1">
                                        <input type="checkbox" name="cities" value="{{ $city->id }}" class="chk-brand"
                                            @if(in_array($city->id, explode(',', $f_cities))) checked="checked" @endif>
                                        {{ $city->name }}
                                    </span>
                        ...
                        <div class="accordion-body px-0 pb-0 pt-3 category-list">
                            <ul class="list list-inline mb-0">
                                ...
                                <li class="list-item">
                                    ...
                                    <span class="text-right float-end">{{ $party->candidates->filter(function
                                        ($candidate) use ($city) {
        ...
        <div class="shop-list flex-grow-1">
            ...
            <div class="d-flex justify-content-between mb-4 pb-md-2">
                ...
                <div
                    ...
                    <select class="shop-acs__select form-select w-auto border-0 py-0 order-1 order-md-0"
                        aria-label="Page Size" id="pagesize" name="pagesize" style="margin-right: 2px;">
            ...
            <a type="button" class="btn btn-success" href="{{ route('cart.show') }}" class="navigation__link">Ir para o
                resumo do bilhete</a>
            @else
                    ...
                    <div class="product-card mb-3 mb-md-4 mb-xxl-5">
                        <div class="pc__img-wrapper">
                            <div class="swiper-container background-img js-swiper-slider"
                                ...
                                <div class="swiper-wrapper">
                                    <div class="swiper-slide">
                                        <a
                                            href="{{-- route('shop.candidate.show', ['candidate_slug' => $candidate->slug]) --}}"><img
                                                loading="lazy"
                                                src="{{ asset('uploads/candidates') }}/{{ $candidate->image }}"
                                                width="330" height="400" alt="{{ $candidate->short_name }}"
                                                class="pc__img"></a>
                                    </div>
                                </div>
                            ...
                            <form name="addtocart-form" method="post"
                                action="{{ route('cart.add', ['candidateId' => $candidate->id]) }}" id="myForm"
                                class="submitForm">
                                @csrf
                                <button type="submit"
                                    class="pc__atc btn anim_appear-bottom btn position-absolute border-0 text-uppercase fw-medium"
                                    data-aside="cartDrawer" title="Add To Cart">Adicionar ao bilhete</button>
                            </form>
                            @endif
                        </div>
                        ...
                        <div class="pc__info position-relative">
                            <h6 class="pc__title"><a
                                    href="{{-- route('shop.candidate.show', ['candidate_slug' => $candidate->slug]) --}}">{{
                                    $candidate->short_name }}</a></h6>
                            <p class="pc__category">{{ $candidate->party->acronym }}</p>
